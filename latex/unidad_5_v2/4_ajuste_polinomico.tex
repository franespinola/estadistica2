...
\begin{center}
{\fontsize{17}{21}\selectfont\bfseries Ajuste polinomico}
\end{center}
...
\vspace{-16pt}
Para estimar los $p+1$ coeficientes óptimos (denotados en la muestra como $b_0, b_1, \ldots, b_p$), aplicamos el método de \textbf{Mínimos Cuadrados Ordinarios}. El objetivo es encontrar aquellos estimadores que minimicen de forma conjunta la \textbf{Suma de Cuadrados de Error (SCE)}, definida como:
\[
...
\paso{2} \ \textbf{Derivamos e igualamos a 0 los p+1 valor (b0,b1,b2....)}
...
\paso{3} \ \textbf{Armamos sist. ec. y matriz}
